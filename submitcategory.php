...
<body>
  ...
  <h2>Showing all results filtered by category...</h2>
        ...
        <div class="container py-2">
          <div class="row mt-3">
            ...
            if (mysqli_num_rows($query_run) > 0) {
              ...
              echo "<div class='alerti alert-success mt-3 text-center' role='alert' style='color:white'>$row_cnt doctor(s) of  category : $check found! </div>";
